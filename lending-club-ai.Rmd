...
Data preprocessing, the following steps are executed:
...
Create dummy variables of nominal predictors.

Normalize and scale all numeric variables
...
Validate the model using the test data (output estimates)
```{r}
# Predicted Class
